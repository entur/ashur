...
class FromDateRefHandlerTest {
    ...
    @Test
    fun handlerCollectsFromDateRefForOperatingPeriod() {
        ...
        assertEquals(
            fromDateId,
            repo.getOperatingPeriodData(operatingPeriodId).fromDateId,
        )
    }
}